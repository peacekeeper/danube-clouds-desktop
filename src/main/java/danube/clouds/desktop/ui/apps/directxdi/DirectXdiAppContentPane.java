...
import danube.clouds.desktop.xdi.XdiUtil;
...
public class DirectXdiAppContentPane extends ContentPane {
	...
	public void init() {
		...
		this.fromSelectField.setModel(new DefaultListModel(DanubeCloudsDesktopApplication.getApp().getParties().toArray()));
		this.toSelectField.setModel(new DefaultListModel(DanubeCloudsDesktopApplication.getApp().getRemoteParties().toArray()));
	}
	...
	private void initComponents() {
		...
		ResourceImageReference imageReference2 = new ResourceImageReference(
				"/danube/clouds/desktop/resource/image/cloud_big_direct.png");
