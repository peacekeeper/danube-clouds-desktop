...
public class MessageDialog extends WindowPane {
	...
	= new ResourceImageReference("/danube/clouds/desktop/resource/image/icon/message/message-problem.png");
	public static final ImageReference ICON_INFORMATION
	= new ResourceImageReference("/danube/clouds/desktop/resource/image/icon/message/message-info.png");
	public static final ImageReference ICON_QUESTION
	= new ResourceImageReference("/danube/clouds/desktop/resource/image/icon/message/message-question.png");
	public static final ImageReference ICON_WARNING
	= new ResourceImageReference("/danube/clouds/desktop/resource/image/icon/message/message-warning.png");
	...
	public void show() {
		...
		Component mainContentPane = DanubeCloudsDesktopApplication.getApp().getDefaultWindow().getContent();
	...
	private void initComponents() {
		resourceBundle = ResourceBundle.getBundle(
				"danube.clouds.desktop.resource.localization.Messages",
