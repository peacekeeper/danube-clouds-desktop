...
import danube.clouds.desktop.ui.xdi.SendEventWindowPane;

public class SendEventPanel extends Panel {

	private static final long serialVersionUID = -5082464847478633075L;

	private static final ImageReference IMAGEREFERENCE_SUCCESS = new ResourceImageReference("/danube/clouds/desktop/resource/image/transactionsuccess.png");
	private static final ImageReference IMAGEREFERENCE_FAILURE = new ResourceImageReference("/danube/clouds/desktop/resource/image/transactionfailure.png");
