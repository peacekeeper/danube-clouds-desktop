package danube.clouds.desktop.ui.log;
...
import danube.clouds.desktop.events.LogListener;
import danube.clouds.desktop.logger.LogEntry;
import danube.clouds.desktop.logger.Logger;
import danube.clouds.desktop.ui.html.HtmlLabel;
import danube.clouds.desktop.util.HtmlUtil;
...
public class LogContentPane extends ContentPane implements LogListener, XDIClientListener, EppListener {
	...
	public void init() {
		...
		DanubeCloudsDesktopApplication.getApp().getEvents().addLogListener(this);
		DanubeCloudsDesktopApplication.getApp().getEvents().addClientListener(this);
		DanubeCloudsDesktopApplication.getApp().getServlet().getEppTools().addEppListener(this);
	}
	...
	public void dispose() {
		...
		DanubeCloudsDesktopApplication.getApp().getEvents().removeLogListener(this);
		DanubeCloudsDesktopApplication.getApp().getEvents().removeClientListener(this);
		DanubeCloudsDesktopApplication.getApp().getServlet().getEppTools().removeEppListener(this);
	}
	...
	public void onDiscover(XDIDiscoverEvent discoverEvent) {
		...
		Logger logger = DanubeCloudsDesktopApplication.getApp().getLogger();
	...
	private void initComponents() {
		...
		contentPane2LayoutData.setTitle("Information Log");
